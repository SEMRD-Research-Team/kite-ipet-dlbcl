  ...
  cohort %>%
    arrange(token_person_id) %>%
      ...
      mutate(index_date = if_else(
        ((source == "inpatient") &
         (year(index_dlbcl_admidate) >= 2021) &
         (year(index_dlbcl_admidate) <= 2023)), 
            index_dlbcl_admidate, 
            index_dlbcl_date)) %>%
...
#4879 are 0s (index_dlbcl_date or index_dlbcl_admidate as index_date),
#2964 are 1s (chemo_date as index_date)
